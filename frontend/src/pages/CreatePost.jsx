    ...
    <div className="px-6 md:px-[200px] mt-8">
      ...
      <form className="w-full flex flex-col space-y-4 md:space-y-8 mt-4">
        ...
        <div className="flex flex-col">
          ...
          <textarea onKeyDown={ e => handleKeyPressSubmit(e)} onChange={ e => setDesc(e.target.value)} cols="30" rows="15" className='px-4 py-2 outline-none' placeholder='Enter post Description'></textarea>
          <button onClick={handleCreate} className='bg-slate-800 w-full md:w-[20%] mx-auto text-slate-100 font-semibold px-4 py-2 text-lg md:text-xl'>Post</button>
        </div>
      </form>
    </div>
    </>
